...
export const ClassicyControlGroup: React.FC<ClassicyControlGroupProps> = ({ label = '', columns = false, children }) => {
    return (
        <fieldset
        ...
        >
            {label !== '' && <legend className={"classicyControlGroupLegend"}>{label}</legend>}
