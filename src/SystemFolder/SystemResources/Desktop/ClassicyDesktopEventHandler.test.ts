...
describe("classicyDesktopEventHandler — ClassicyDesktopAppMenuAdd", () => {
  it("adds a new menu item to systemMenu", () => {
    ...
    expect(ds.System.Manager.Desktop.systemMenu[0].id).toBe("system_menu_Notes.app");
...
describe("classicyDesktopEventHandler — ClassicyDesktopStop", () => {
  it("resets selectBox to inactive with zeroed size and start", () => {
    const ds = makeStoreForDesktop();
    ds.System.Manager.Desktop.selectBox = { active: true, size: [100, 200], start: [50, 60] };
...
describe("classicyDesktopEventHandler — ClassicyDesktopContextMenu", () => {
  it("sets showContextMenu to true", () => {
    const ds = makeStoreForDesktop();
    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopContextMenu", showContextMenu: true });
  ...
  it("sets showContextMenu to false", () => {
    ...
    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopContextMenu", showContextMenu: false });
...
describe("classicyDesktopEventHandler — ClassicyDesktopChangeTheme", () => {
  it("switches activeTheme to the found theme", () => {
    const ds = makeStoreForDesktop();
    const altTheme = { ...ds.System.Manager.Appearance.activeTheme, id: "alt-theme", name: "Alt" };
    ds.System.Manager.Appearance.availableThemes.push(altTheme);

    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopChangeTheme", activeTheme: "alt-theme" });
  ...
  it("does not change activeTheme for an unknown theme id", () => {
    ...
    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopChangeTheme", activeTheme: "nonexistent-theme" });
...
describe("classicyDesktopEventHandler — ClassicyDesktopChangeBackground", () => {
  it("sets backgroundImage and resets backgroundSize to 'auto'", () => {
    ...
    expect(ds.System.Manager.Appearance.activeTheme.desktop.backgroundImage).toBe("wallpaper.jpg");
    expect(ds.System.Manager.Appearance.activeTheme.desktop.backgroundSize).toBe("auto");
  });
});
...
describe("classicyDesktopEventHandler — ClassicyDesktopChangeBackgroundPosition", () => {
  it("sets backgroundPosition", () => {
    ...
    expect(ds.System.Manager.Appearance.activeTheme.desktop.backgroundPosition).toBe("top left");
  });
});
...
describe("classicyDesktopEventHandler — ClassicyDesktopChangeBackgroundRepeat", () => {
  it("sets backgroundRepeat", () => {
    ...
    expect(ds.System.Manager.Appearance.activeTheme.desktop.backgroundRepeat).toBe("repeat-x");
  });
});
...
describe("classicyDesktopEventHandler — ClassicyDesktopChangeBackgroundSize", () => {
  it("sets backgroundSize", () => {
    ...
    expect(ds.System.Manager.Appearance.activeTheme.desktop.backgroundSize).toBe("cover");
  });
});
...
describe("classicyDesktopEventHandler — ClassicyDesktopChangeFont", () => {
  it("sets body font", () => {
    const ds = makeStoreForDesktop();
    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopChangeFont", fontType: "body", font: "Chicago" });

    expect(ds.System.Manager.Appearance.activeTheme.typography.body).toBe("Chicago");
  });

  it("sets ui font", () => {
    const ds = makeStoreForDesktop();
    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopChangeFont", fontType: "ui", font: "Monaco" });

    expect(ds.System.Manager.Appearance.activeTheme.typography.ui).toBe("Monaco");
  });

  it("sets header font", () => {
    const ds = makeStoreForDesktop();
    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopChangeFont", fontType: "header", font: "Charcoal" });

    expect(ds.System.Manager.Appearance.activeTheme.typography.header).toBe("Charcoal");
  });
});
...
describe("classicyDesktopEventHandler — ClassicyDesktopLoadThemes", () => {
  it("replaces availableThemes with the provided list", () => {
    ...
    classicyDesktopEventHandler(ds, { type: "ClassicyDesktopLoadThemes", availableThemes: newThemes });
