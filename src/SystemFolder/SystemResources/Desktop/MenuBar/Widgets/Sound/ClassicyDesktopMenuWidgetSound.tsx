...
import {useSound, useSoundDispatch} from '@/SystemFolder/ControlPanels/SoundManager/ClassicySoundManagerContext'
...
export const ClassicyDesktopMenuWidgetSound: React.FC<ClassicyDesktopMenuWidgetSoundProps> = ({hide = false}) => {
