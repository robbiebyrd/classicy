...
vi.mock("@/SystemFolder/SystemResources/RadioInput/ClassicyRadioInput.scss", () => ({}));
...
describe("ClassicyRadioInput", () => {
  ...
  it("renders label when label prop is provided", () => {
    render(<ClassicyRadioInput name="test-group" label="Choose one" inputs={baseInputs} />);
  ...
  it("calls onClickFunc when a radio is clicked", async () => {
    ...
    render(
      <ClassicyRadioInput name="test-group" inputs={baseInputs} onClickFunc={onClickFunc} />,
    );
  ...
  it("disabled individual radio cannot be changed", async () => {
    ...
    render(
      <ClassicyRadioInput name="test-group" inputs={inputs} onClickFunc={onClickFunc} />,
    );
