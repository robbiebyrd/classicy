...
export const ClassicyDisclosure: React.FC<ClassicyDisclosureProps> = ({ direction = 'right', label = '', children }) => {
    ...
    return (
        <div className={classNames("classicyDisclosure")}>
            ...
            <div className={classNames(
                "classicyDisclosureInner", open ? "classicyDisclosureInnerOpen" : "classicyDisclosureInnerClose"
            )}>
                {children}
            </div>
        </div>
