...
export const ClassicySoundDispatchContext = createContext<Dispatch<any>>(
...
export const ClassicySoundStateEventReducer = (
  ...
  switch (validatedAction) {
    ...
    case ClassicySoundActionTypes.ClassicySoundDisableOne: {
      if (action.disabled) {
        let disabled = Array.isArray(action.disabled)
          ? action.disabled
          : [action.disabled];
    ...
    case ClassicySoundActionTypes.ClassicySoundEnableOne: {
      let enabled = Array.isArray(action.enabled)
        ? action.enabled
        : [action.enabled];
...
export const ClassicySoundManagerProvider: React.FC<{ children: any }> = ({
  children,
}) => {
