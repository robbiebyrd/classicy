...
export const ClassicyAppearanceManager: React.FC = () => {
  ...
  const themesList =
    desktopContext.System.Manager.Appearance.availableThemes?.map(
      (a: ClassicyTheme) => (({ id, name }) => ({ value: id, label: name }))(a),
    );
        ...
        <>
          ...
          {themesList && (
            <ClassicyPopUpMenu
              ...
              selected={
                desktopContext.System.Manager.Appearance.activeTheme.id ||
                "default"
              }
            />
          )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1em" }}>
          <div style={{ display: "flex", flexDirection: "row", gap: "1em" }}>
            ...
            <ClassicyPopUpMenu
              ...
              options={fonts}
              selected={
                desktopContext.System.Manager.Appearance.activeTheme.typography
                  .ui
              }
